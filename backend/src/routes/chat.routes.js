...
import { createGroupChat, deleteGroupChat, editGroupChat, getChats, getConversation, leaveGroupChat } from "../controllers/chat.controller.js";


const router = express.Router();

router.get("/user-chat/:id", verifyJWT, getConversation);
