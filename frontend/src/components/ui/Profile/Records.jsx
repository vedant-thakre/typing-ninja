      ...
      <div className="w-full flex flex-col px-4 pb-4  gap-2">
        <div>
          <div className="grid grid-cols-12 px-5 w-full">
            ...
            <p className="col-span-8 font-main  text-[15px] pb-3 font-light text-textsecond">
              Name
            </p>
            <p className="col-span-1 font-main text-end pr-3 text-body2 pb-3 font-light text-textsecond">
              WPM
            </p>
          </div>
